...
#from .utils import is_admin, is_doctor, is_patient
...
def afterlogin_view(request):
    if is_admin(request.user):
        ...
        if accountapproval:
            ...
            # Handle the case where the user doesn't match any role
        return HttpResponse("You don't have the necessary role for access.")
